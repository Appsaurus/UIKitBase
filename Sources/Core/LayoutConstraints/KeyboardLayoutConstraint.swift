...
open class KeyboardLayoutManager: NSObject {
    ...
    open func startListening() {
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(KeyboardLayoutManager.keyboardWillShowNotification(_:)),
                                               name: UIResponder.keyboardWillShowNotification,
                                               object: nil)
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(KeyboardLayoutManager.keyboardWillHideNotification(_:)),
...
open class KeyboardAwareLayoutConstraint: NSLayoutConstraint, NotificationObserver {
    ...
    open func animateConstant(_ constant: CGFloat, notification: Notification) {
        ...
        firstView?.animateConstraintChanges({ [weak self] in
...
open class KeyboardAdjustableLayoutConstraint: KeyboardAwareLayoutConstraint {
    ...
    open class func createConstraint(item view1: AnyObject,
                                     ...
                                     keyboardVisibleConstant: CGFloat) -> KeyboardAdjustableLayoutConstraint
    {
        let constraint = KeyboardAdjustableLayoutConstraint(item: view1,
                                                            ...
                                                            constant: keyboardHiddenConstant)
        constraint.didInit()

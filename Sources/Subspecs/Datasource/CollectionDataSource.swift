...
// open class CollectionDataSource<Value: Hashable>: SectionedCollectionDataSource<String, Value> {
//    open override func group(values: [Value]) -> [String: [Value]] {
//        return ["": values] // Defaults to single section collection
//    }
// }
//
// open class SectionedCollectionDataSource<SectionKey: Hashable, Value: Hashable> {
//    public init() {}
//
...
// open class DatasourceManagedTableViewController<ModelType: Hashable>: BaseTableViewController, AsyncDatasourceChangeManager {
